...
export class PatientService {
  public resourceUrl = SERVER_API_URL + 'services/patientservice/api/patients';
  public resourceSearchUrl = SERVER_API_URL + 'services/patientservice/api/_search/patients';
