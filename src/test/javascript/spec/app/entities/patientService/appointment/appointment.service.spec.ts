...
describe('Service Tests', () => {
  describe('Appointment Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Appointment(0, PatientStatus.INPATIENT, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Appointment', () => {
        const returnedFromService = Object.assign(
          {
            patientStatus: 'BBBBBB',
            diseaseIdentified: 'BBBBBB',
            cureSuggested: 'BBBBBB',
            testsSuggested: 'BBBBBB'
          },
          elemDefault
        );
