...
import { WorkingScheduleComponent } from 'app/entities/patientService/working-schedule/working-schedule.component';
...
describe('Component Tests', () => {
  describe('WorkingSchedule Management Component', () => {
    let comp: WorkingScheduleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WorkingScheduleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.workingSchedules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
