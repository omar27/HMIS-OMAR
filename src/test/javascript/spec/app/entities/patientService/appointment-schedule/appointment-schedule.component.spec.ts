...
import { AppointmentScheduleComponent } from 'app/entities/patientService/appointment-schedule/appointment-schedule.component';
...
describe('Component Tests', () => {
  describe('AppointmentSchedule Management Component', () => {
    let comp: AppointmentScheduleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AppointmentScheduleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new AppointmentSchedule(123)],
            headers
          })
        )
      );
      ...
      expect(comp.appointmentSchedules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
