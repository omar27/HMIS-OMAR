...
import { InPatientComponent } from 'app/entities/patientService/in-patient/in-patient.component';
...
describe('Component Tests', () => {
  describe('InPatient Management Component', () => {
    let comp: InPatientComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InPatientComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inPatients[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
